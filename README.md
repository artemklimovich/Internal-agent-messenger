...
GitHub: [artemklimovich/Internal-agent-messenger](https://github.com/artemklimovich/Internal-agent-messenger)
...
Подробно: [docs/MAG-MASTER.md](docs/MAG-MASTER.md), [docs/MAGBOT.md](docs/MAGBOT.md), [docs/CONNECTING-AGENTS.md](docs/CONNECTING-AGENTS.md).
...
Details: [docs/MAG-MASTER.md](docs/MAG-MASTER.md), [docs/MAGBOT.md](docs/MAGBOT.md), [docs/CONNECTING-AGENTS.md](docs/CONNECTING-AGENTS.md).
