...
3. UI на русском (продукт MAG). Документация — русский и английский.
4. Чужой эфир должен оставаться пейджером.
...
3. Product UI is Russian. Docs are bilingual.
4. Foreign ether must stay pager-only.

Issues: https://github.com/artemklimovich/Internal-agent-messenger/issues
